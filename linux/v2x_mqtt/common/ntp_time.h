...
#define NTP_TIME_ISO8601_UTC_STRLEN 24U

typedef enum { NTP_SYNC_OK = 0x00, NTP_SYNC_RTC_ONLY = 0x01, NTP_SYNC_NONE = 0x02 } NtpSyncStatus;
...
bool ntp_time_format_iso8601_utc(uint64_t timestamp_epoch_ms, char out[NTP_TIME_ISO8601_UTC_STRLEN + 1]);
